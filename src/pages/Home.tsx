        ...
        <div className="grid sm:grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8 max-w-5xl mx-auto">
          ...
          >
            ...
            <p className="text-white/90 text-base sm:text-lg mb-4 sm:mb-6">
              Explore chord progressions and scales for all major and minor keys.
          ...
          >
            ...
            <p className="text-white/90 text-base sm:text-lg mb-4 sm:mb-6">
              Create, edit, and manage your personal collection of songs with chords.
              Keep all your favorite songs organized in one place.
            </p>
            <div className="flex items-center text-white font-semibold">
